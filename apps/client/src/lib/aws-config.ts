...
export const CLOUDFORMATION_TEMPLATE_URL =
    "https://raw.githubusercontent.com/jorgedanisc/boreal/main/packages/infra/boreal-template.yaml";
...
export function getCloudFormationQuickCreateUrl(region: string, tier: StorageTier): string {
    ...
    return `https://${region}.console.aws.amazon.com/cloudformation/home?region=${region}#/stacks/quickcreate?templateURL=${templateUrl}&stackName=${stackName}`;
}
